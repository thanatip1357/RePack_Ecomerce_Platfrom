...
//   // Create connection
// $conn = new mysqli($servername, $username, $password, $dbname,3380);
// if(isset($_GET['id'])){
...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-banner jarallax min-height300 padding-large" style="background: url(images/aboutus.png) no-repeat;">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
        ...
        <div class="row d-flex align-items-center">
          <div class="col-lg-6 col-md-12">
            <div class="image-holder">
              <img src="aboutus_img.jpg" alt="single" class="about-image">
            </div>
          </div>
          <div class="col-lg-6 col-md-12">
            <div class="detail">
              <div class="display-header">
                <h2 class="section-title">How was RePack started?</h2>
                <p>RePack's inception traces back to a pivotal moment experienced by one of our founders, Hemant. Prompted by the inefficiencies encountered during a simple online purchase - from the time wasted on delivery to the challenges of locating the correct address, he recognized a pressing need for innovation in the E-commerce delivery process.
                <br>
                This experience ignited the spark that led to the birth of RePack. Dismayed by the hurdles of traditional delivery methods, Hemant and our founding team embarked on a journey to develop a solution that would not only address these challenges but also contribute to a more sustainable future.</p>
                <div class="btn-wrap">
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="testimonial-detail">
                      <p>“Sustainability isn't just a choice; it's our responsibility. At RePack, we're committed to reshaping the way we think about packaging and delivery in E-commerce. Through our innovative solutions and collaborative efforts, we're paving the way for a more sustainable future. Join us in our mission to make every package returned a step towards a brighter, greener tomorrow.</p>
                      <div class="author-detail">
                        <div class="name">The RePack Team</div>
                      </div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="testimonial-detail">
                      <p>“Every returned package is a step towards a greener tomorrow. At RePack, we believe in the power of collective action to drive positive change in E-commerce. Join us on our journey as we reimagine packaging not just as a means to deliver goods, but as a catalyst for sustainability innovation. Together, let's build a world where every purchase contributes to a more sustainable future for generations to come.”</p>
                      <div class="author-detail">
                        <div class="name">The RePack Team</div>
                      </div>
                    </div>
